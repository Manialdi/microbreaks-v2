...
export default function Login() {
    ...
    return (
        <>
            {/* Fixed Background Layer to cover entire viewport */}
            <div className="fixed inset-0 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 z-[-1]" />

            <div className="flex flex-col items-center justify-center min-h-screen w-full text-white p-6 relative">
