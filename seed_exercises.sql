...
Loop ends.', 60, '/videos/chin-tucks.mp4'),
...
Repeat.', 60, '/videos/side-neck-stretch.mp4'),
...
Repeat on other side.', 60, '/videos/seated-neck-rotation.mp4'),
...
Release (2 sec): Back to upright position.', 60, '/videos/upper-body-arm-stretch.mp4'),
...
Change Hand.', 60, '/videos/triceps-stretch.mp4'),
...
Back to center position (2 sec).', 60, '/videos/seated-side-stretch.mp4'),
...
Hold Stretch (25 sec).
Release (3 sec): Back to start position.', 60, '/videos/pectoralis-stretch.mp4'),
...
Hold Stretch (26 sec): Stretch held comfortably.
Return to Neutral (2 sec).', 60, '/videos/seated-hip-stretch.mp4'),
...
Repeat with other leg.', 60, '/videos/heel-slides.mp4'),
...
5 sec loop.', 60, '/videos/sit-to-stands.mp4'),
...
3 sec loop.', 60, '/videos/seated-calf-raises.mp4'),
...
Release (1 sec).
Repeat on other side.', 60, '/videos/wrist-flexor-stretch.mp4'),
...
Other side rotation for 30 sec.', 60, null),

-- 15. Eye Circles
('Eye Circles', 'eye', '4 seconds for one figure-8 eye movement.
Repeat continuously.', 60, '/videos/eye-8-rotation.mp4');
